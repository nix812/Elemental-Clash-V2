...
const Audio = (() => {
  ...
  function init() {
    ...
    startHum();
    // Decode raw buffers that arrived before AudioContext existed
    ...
    // Queue menu BGM if already on a menu screen
...
(function() {
  fetch('https://raw.githubusercontent.com/nix812/Elemental-Clash-V2/main/audio/bgm-battle.mp3')
    ...
    .then(buf => Audio.loadMatchBGM(buf))
...
(function() {
  fetch('https://raw.githubusercontent.com/nix812/Elemental-Clash-V2/main/audio/bgm-menu.mp3')
    .then(r => r.arrayBuffer())
    .then(buf => Audio.loadMenuBGM(buf))
